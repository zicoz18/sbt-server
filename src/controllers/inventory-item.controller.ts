...
import { Inventory, InventoryItem, ItemName } from '../models';
...
export class InventoryItemController {
  ...
  //#region InventoryItem belongsTo ItemName 
  @get('/inventory-items/{id}/item-name', {
    responses: {
      '200': {
        description: 'ItemName belonging to InventoryItem',
        content: {
          'application/json': {
  ...
  async getItemName(
    @param.path.string('id') id: typeof InventoryItem.prototype.id,
  ): Promise<ItemName> {
    return this.inventoryItemRepository.itemName(id);
  }
  //#endregion

  //#region InventoryItem belongsTo Inventory

  @get('/inventory-items/{id}/inventory', {
    responses: {
      '200': {
        description: 'Inventory belonging to InventoryItem',
        content: {
          'application/json': {
  ...
  async getInventory(
    ...
    return this.inventoryItemRepository.inventory(id);
  }
  //#endregion
